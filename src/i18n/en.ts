export default {
  ...
  "settings.maxContextImages.name": "Max Context Images", 
  "settings.maxContextImages.desc": "Maximum number of historical images to include in AI conversations",
  ...
  "settings.contextStrategy.name": "Context Selection Strategy",
  "settings.contextStrategy.desc": "How to select which historical messages to include",
  "settings.contextStrategy.recent": "Most Recent",
  "settings.contextStrategy.smart": "Smart Selection",
